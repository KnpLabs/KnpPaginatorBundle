        ...
        $builder->root('knp_paginator')
            ...
            ->children()
                ...
                ->arrayNode('synced_request_params')
                    ...
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->booleanNode('sort_param')->defaultValue(false)->end()
                        ->booleanNode('sort_direction_param')->defaultValue(false)->end()
                        ->booleanNode('filter_field_param')->defaultValue(false)->end()
                        ->booleanNode('filter_value_param')->defaultValue(false)->end()
                    ->end()
                ->end()
                ->arrayNode('template')
                    ->addDefaultsIfNotSet()
